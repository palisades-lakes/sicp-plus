...
In my particular setup, attempting to create an {\javaFont int[]}
{\javaFont Integer.MAX\_VALUE-1} result in:
...
represented by {\javaFont BoundedNatural} and {\javaFont BigInteger},
...
{\javaFont Integer.MAX\_VALUE/32}, or
