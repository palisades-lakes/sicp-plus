...
$\Sub{F}(a) \;\Add{F}\; a = \Zero{F}$.
Binary subtraction is defined as the composition 
of addition and inverse:
$a \,\Sub{F}\, b = 
a \,\Add{F}\, \left(\Sub{F}(b)\right) $

\item[Multiplicative inverse:] 
$\Div{F}(a) \;\Mul{F}\; a = \One{F}$ for all $a \neq \Zero{F}$.
...
$\left( a \Add{F} b \right)  \Add{F} c 
\,=\, 
a  \Add{F} \left( b  \Add{F} c \right)$

\item[Associative multiplication:] 
$\left( a  \Mul{F} b \right) \Mul{F} c 
\,=\, 
a \Mul{F} \left( b \Mul{F} c \right)$
...
$a \, \Mul{F} \, \left( b \Add{F} c \right)
\,=\, 
\left(a \Mul{F} b \right) 
\, \Add{F} \, 
\left(a \Mul{F} c \right)$
...
\end{plSection}%{Unexamined assumptions}
%-----------------------------------------------------------------
...
\item[Identity:] $\Ide{\Add{N}}() \rightarrow 0_{\Space{N}}$
\item[Associative:] 
...
\citeAuthorYearTitle{LindholmEtAl:2021:JVMS16}
...
\end{plSection}%{\javaFont BoundedNatural}
%-----------------------------------------------------------------
...
\end{plSection}%{\javaFont UnboundedNatural}
%-----------------------------------------------------------------
