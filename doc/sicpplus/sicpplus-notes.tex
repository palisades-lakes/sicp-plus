...
I'm going to start over and try to fix the issues listed above.
...
For my takes on the example in this section see \cref{sec:UOM}.
%-----------------------------------------------------------------
...
\begin{itemize}
  ...
  \emphj{Measurable} as a element of some space independent of
...
\end{plSection}%{Units of measurement}\label{sec:UOM}
%-----------------------------------------------------------------
