...
public final class TotalSum {
  ...
  public static final void main (final String[] args) {
    ...
    for (int i=0;i<trys;i++) {
      ...
      sicpplus.java.numbers.BigFloat b = sicpplus.java.numbers.BigFloat.ZERO;
      //sicpplus.java.numbers.BigFloat0 f = sicpplus.java.numbers.BigFloat0.ZERO;
...
//      sicpplus.jmh.accumulators.BigFloatAccumulator0.make();
