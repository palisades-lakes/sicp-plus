...
import sicpplus.java.test.polynomial.MonomialEFloat;
...
public final class Common {
  ...
  public static final List<String> inexactAccumulators () {
    return
      Arrays.asList(
        new String[]
          { "sicpplus.java.accumulators.DoubleAccumulator",
            "sicpplus.java.accumulators.KahanAccumulator",
          }); }
  ...
  public static final List<String> accumulators () {
    return
      Arrays.asList(
        new String[]
          { //"sicpplus.java.test.accumulators.ERationalAccumulator",
            //"sicpplus.java.test.accumulators.EFloatAccumulator",
            "sicpplus.java.accumulators.DistilledAccumulator",
            "sicpplus.java.accumulators.ZhuHayesAccumulator",
            "sicpplus.java.accumulators.BigFloatAccumulator",
            "sicpplus.java.accumulators.RationalFloatAccumulator",
          }); }
